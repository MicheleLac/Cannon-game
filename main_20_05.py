...
class CannonGame(Widget):
    ...
    def update(self, dt):
        ...
        def check_collision(self,bullet, obstacle):
            # Get the coordinates of the bullet and obstacle
            bullet_x, bullet_y = bullet.pos
            bullet_w, bullet_h = bullet.size
            obstacle_x, obstacle_y = obstacle.pos
            obstacle_w, obstacle_h = obstacle.size

        # Check for collision
            if (bullet_x < obstacle_x + obstacle_w and bullet_x + bullet_w > obstacle_x and
                bullet_y < obstacle_y + obstacle_h and bullet_y + bullet_h > obstacle_y):
                return True
            else:
                return False
        ...
        for bullet in self.bullets:
            ...
            """if check_collision(CannonGame, bullet=bullet, obstacle=self.mirror):
